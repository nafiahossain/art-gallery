...
if(isset($_POST['edit_user']))
{
    ...
    $query = "UPDATE `users` SET `fullname`='$editname',`username`='$editname',`email`='$editemail',
             `phone`='$editphone',`password`='$editpassword' WHERE `u_id`='$editid';";
...
<head>
    ...
    <title>Update Profile | ArtSpace</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container d-sm-flex align-items-center justify-content-center mb-4">
            <h1 class="h3 mb-0 text-gray-800"><u>Update Your Profile</u></h1>    
        </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="<?php echo $row['phone'] ?>" class="form-control" placeholder="Enter Contact Number" required>
                            </div>
                            <div class="form-group">
