    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin_gallery.php">Add & View Galleries</a>
                <a class="collapse-item" href="gallery_edit.php">Edit Galleries</a>
                <a class="collapse-item" href="admin_shows.php">Add & View Shows</a>
                <a class="collapse-item" href="shows_edit.php">Edit Shows</a>
                <a class="collapse-item" href="admin_artist.php">Add & View Artists</a>
